(function () {
	...
	const options = {
		...
		linkSelector: '.mry-anima-link:not([data-no-swup])',
	...
	// maps
	if ($("div").is("#map-dark")) {
		mapboxgl.accessToken = 'pk.eyJ1Ijoib25lY2EiLCJhIjoiY2tuZnkyMWYxMDF4MTJ1b2J3MDgza2FvNiJ9.T3H-1c5oEms9ZcutAueHBQ';
		var map = new mapboxgl.Map({
			container: 'map-dark',
			style: 'mapbox://styles/stoscar/ckk75h29r02ol17rrilp215vd',
			center: [69.24533687483533, 41.2877995501595],
			zoom: 11
		});

		var marker = new mapboxgl.Marker()
			.setLngLat([69.24533687483533, 41.2877995501595])
			.addTo(map);
	}
